...
const columns = [
  ...
  {
    title: "Resources",
    links: ["Documentation", "API Reference", "Guides", "Security", "Blog"],
  },
  {
    title: "Company",
    ...
    <footer className="border-t border-border bg-card/20">
      <div className="mx-auto w-full max-w-6xl px-6 py-14">
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-[1.5fr_repeat(4,1fr)]">
          <div className="col-span-2 max-w-xs sm:col-span-3 lg:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              AI knowledge management for teams. One searchable brain for every
              tool your team uses.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 text-sm text-muted-foreground sm:flex-row">
          <p>© 2026 Nexus Labs, Inc. All rights reserved.</p>
