    ...
    >
      ...
      <Container className="flex flex-col items-center text-center">
        ...
        >
          ...
          Nexus 2.0 — agentic search across every tool
          <ArrowRight className="size-3.5 transition-transform group-hover:translate-x-0.5" />
        </Link>

        <h1 className="animate-rise max-w-3xl text-balance text-4xl font-semibold leading-[1.05] tracking-tight sm:text-6xl">
          <span className="text-gradient">Your team&apos;s knowledge,</span>
          <br />
          <span className="bg-gradient-to-r from-brand to-violet-300 bg-clip-text text-transparent">
            finally findable.
          </span>
        </h1>
        ...
        >
          Nexus connects your docs, chats, and tools into one searchable brain.
          Ask a question in plain English and get a sourced answer in seconds,
          not a list of links.
        </p>
