        ...
        <div className="relative isolate overflow-hidden rounded-3xl border border-brand/25 bg-card/40 px-6 py-16 text-center sm:px-12">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-5 max-w-xl text-pretty leading-relaxed text-muted-foreground">
              Connect your first tool and ask your first question in under five
              minutes. Free for 14 days, no credit card required.
            </p>
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <a
                href="mailto:sales@nexus.app?subject=Nexus%20demo"
                className={cn(
